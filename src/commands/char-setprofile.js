...
module.exports = {
	...
	description: 'Creates a profile for your active character.  Via DM only.',
	oneline: true,
	aliases: ['setprofile'],
	usage: '',
	DMOnly: true,
		...
		Player.getPlayer(message, function (player) {
			...
			Character.findById(player.selectedCharacter).exec(function (err, character) {
				...
				message.channel.send(
					"Setting up your character description takes a few steps. I will cancel the process if you type exit, if there is an error, or if you do not respond for 1 hour.\n" +
					"[1/7] Characters are \"called\" using a unique one-word shortname. What is this character's Call? (Example: Paul, JohnSmith.) Write 'skip' to keep the name unchanged or 'exit' to stop the process.\n" +
						...
						.then(collected => {
							...
							character.save(function (err) {
								...
								message.channel.send(
									...
									"[2/7] (Optional) What is your character's full name? This displays on your character profile. (Max Length: 40, or skip or exit.)\n" +
										...
										.then(collected => {
											...
											character.save(function (err) {
												...
												message.channel.send(
													...
													"[3/7] (Optional) Add a website URL to your character's full name, such as a wiki page. (Or skip or exit..)\n" +
														...
														.then(collected => {
															...
															character.save(function (err) {
																...
																message.channel.send(
																	...
																	"[4/7] (Optional) Add the URL of an image that shows your character. (Or skip or exit.)\n" +
																		...
																		.then(collected => {
																			...
																			character.save(function (err) {
																				...
																				message.channel.send(
																					...
																					"[5/7] (Optional) Add the URL of a badge or thumbnail that will decorate your character profile, e.g. your pack or clan symbol. (Or skip or exit.)\n" +
																						...
																						.then(collected => {
																							...
																							character.save(function (err) {
																								...
																								message.channel.send(
																									...
																									"[6/7] (Optional) Add a description for your character. (Max Length: 1000, or skip or exit.)\n" +
																										...
																										.then(collected => {
																											...
																											character.save(function (err) {
																												...
																												message.channel.send(
																													...
																													"[7/7] (Optional) Add a brief RP style or theme description for this character. (Max Length: 150, or skip or exit.)\n" +
																													...
																													message.channel.awaitMessages(filter, { max: 1, time: 3600000, errors: ['time'] })
																														...
																														.catch(collected => {
																															message.channel.send('Exited profile setup due to timeout.');
																														});
																												});
																												// Closing step 6
																											});
